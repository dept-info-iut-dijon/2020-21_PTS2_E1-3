 ...
 * @author margu
 */
public class LoginExist extends javax.swing.JFrame {

    /**
     * Creates new form loginExist
     */
    public LoginExist() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginExist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginExist().setVisible(true);
            }
        });
    }
