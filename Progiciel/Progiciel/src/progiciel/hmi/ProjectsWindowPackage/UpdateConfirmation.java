 ...
 * @author margu
 */
public class UpdateConfirmation extends javax.swing.JFrame {

    /**
     * Creates new form UpdateConfirmation
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Your project is updated");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateConfirmation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateConfirmation().setVisible(true);
            }
        });
    }
